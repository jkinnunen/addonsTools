...
addon_info = AddonInfo(
	...
	* Add-ons documentation: allow to open the documentation file."""),
	...
	addon_changelog=_("""Set compatibility wit NVDA 2026.x.
	Updated translations for russian and ucranian."""),
	# Author(s)
...
pythonSources: list[str] = ["addon/globalPlugins/addonsTools/*.py", "addon/installTasks.py"]
